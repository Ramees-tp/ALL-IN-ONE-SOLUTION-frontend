        ...
        <div className="w-full md:w-1/2 p-5 md:px-0 mx-5">
          <div className="bg-gray-900 border border-red-500 w-full lg:w-1/2 h-full p-5 pt-8">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="http://www.linkedin.com/in/ramees-muhammad-tp-77294629b" class="flex items-center hover:text-black hover:bg-[#fffa96] p-2">
              ...
              <a href="#" class="flex items-center hover:text-black hover:bg-[#fffa96] p-2">
                  <svg fill="currentColor" class="w-6 h-6 m-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
        ...
        <form action="#" className="w-full md:w-1/2 border border-red-500 p-6 bg-gray-900">
          ...
          <div>
            ...
            <label for="email">Email</label>
              <input 
                  type="text" id="email" 
                  class="px-3 tm:py-2 py-4 w-full bg-gray-800 border border-gray-900 focus:border-[#fffa96] focus:outline-none focus:bg-gray-800 focus:text-[#fffa96]"
                  autoComplete="off"
              />
            </div>
            <div class="flex flex-col mb-3">
              ...
              <textarea 
                  rows="4" id="message" 
                  class="px-3 py-2 bg-gray-800 border border-gray-900 focus:border-[#fffa96] focus:outline-none focus:bg-gray-800 focus:text-[#fffa96]"
              ></textarea>
            </div>
          </div>
