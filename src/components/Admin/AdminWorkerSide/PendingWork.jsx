       ...
       <h2 className="text-2xl font-semibold mb-6">Pending Works</h2>
          <div className="flex flex-col gap-y-5">
            {data.filter(request=>request.payment && !request.completed).map((worker) => (
              <div
                key={worker._id}
                className="flex items-center tm:p-8 p-2 bg-[#9fc3f0] shadow rounded-lg"
              >
                <div className="w-full flex sm:flex-row flex-col justify-center gap-y-2">
                  ...
                  <div className="tm:ml-auto flex sm:flex-col flex-row justify-between items-center px-6">
                    <div
